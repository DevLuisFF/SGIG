...
class ConnectionManager
{
	...
	{
		return $this->byId( "sgig_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "sgig_at_localhost";
		$data["connName"] = "sgig at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;sgig;;1"; //currently unused

		$this->_connectionsIdByName["sgig at localhost"] = "sgig_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "sgig";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=sgig;OPTION=3";
		// encription set
		...
		$connectionsData["sgig_at_localhost"] = $data;
