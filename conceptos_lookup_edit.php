...
require_once("include/conceptos_lookup_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "conceptos_lookup_edit";
...
$page_layouts["conceptos_lookup_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "conceptos_lookup_list";
...
$page_layouts["conceptos_lookup_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "transacciones_list";
$layout->blocks["center"] = array();
$layout->containers["gridcontrols"] = array();
$layout->container_properties["gridcontrols"] = array(  );
$layout->containers["gridcontrols"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["transacciones_list"] = $layout;
