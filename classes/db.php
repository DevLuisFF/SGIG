...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "sgig_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "conceptos", "varname" => "sgig_at_localhost__conceptos", "altvarname" => "conceptos", "connId" => "sgig_at_localhost", "schema" => "", "connName" => "sgig at localhost");
			$dalTables[$conn->connId][] = array("name" => "periodos", "varname" => "sgig_at_localhost__periodos", "altvarname" => "periodos", "connId" => "sgig_at_localhost", "schema" => "", "connName" => "sgig at localhost");
			$dalTables[$conn->connId][] = array("name" => "transacciones", "varname" => "sgig_at_localhost__transacciones", "altvarname" => "transacciones", "connId" => "sgig_at_localhost", "schema" => "", "connName" => "sgig at localhost");
		}
	}
