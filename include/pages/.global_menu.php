...
'group' => false,
'items' => null,
'table' => 'periodos_lookup',
'page' => 'list' ),
'welcome_item4' => array( 'menutItem' => true,
'group' => false,
'items' => null,
'table' => 'conceptos_lookup',
'page' => 'list' ) ) ),
...
'linkTable' => 'conceptos',
'linkPage' => 'list',
'linkText' => array( 'table' => 'conceptos',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'calendar' ),
'linkComments' => array( 'text' => 'Conceptos description',
'type' => 0 ) ),
'welcome_item1' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'periodos',
'linkPage' => 'list',
'linkText' => array( 'table' => 'periodos',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'barcode' ),
'linkComments' => array( 'text' => 'Periodos description',
'type' => 0 ) ),
'welcome_item2' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'transacciones',
'linkPage' => 'list',
'linkText' => array( 'table' => 'transacciones',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'barcode' ),
'linkComments' => array( 'text' => 'Transacciones description',
'type' => 0 ) ),
'welcome_item3' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'periodos_lookup',
'linkPage' => 'list',
'linkText' => array( 'table' => 'periodos_lookup',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'camera' ),
'linkComments' => array( 'text' => 'Periodos Lookup description',
'type' => 0 ) ),
'welcome_item4' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'conceptos_lookup',
'linkPage' => 'list',
'linkText' => array( 'table' => 'conceptos_lookup',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'leaf' ),
'linkComments' => array( 'text' => 'Conceptos Lookup description',
'type' => 0 ) ) ),
'dbProps' => array(  ),
'version' => 2 );
		?>