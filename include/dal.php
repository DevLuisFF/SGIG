...
class tDAL
{
	var $tblsgig_at_localhost__conceptos;
	var $tblsgig_at_localhost__periodos;
	var $tblsgig_at_localhost__transacciones;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "conceptos", "varname" => "sgig_at_localhost__conceptos", "altvarname" => "conceptos", "connId" => "sgig_at_localhost", "schema" => "", "connName" => "sgig at localhost");
		$this->lstTables[] = array("name" => "periodos", "varname" => "sgig_at_localhost__periodos", "altvarname" => "periodos", "connId" => "sgig_at_localhost", "schema" => "", "connName" => "sgig at localhost");
		$this->lstTables[] = array("name" => "transacciones", "varname" => "sgig_at_localhost__transacciones", "altvarname" => "transacciones", "connId" => "sgig_at_localhost", "schema" => "", "connName" => "sgig at localhost");
	}
